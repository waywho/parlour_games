...
RSpec.describe "/game_sessions", type: :request do
  ...
  # GameSessionsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get game_sessions_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
      ...
      it "creates a new GameSession" do
        expect {
          post game_sessions_url,
               params: { game_session: valid_attributes }, headers: valid_headers, as: :json
        }.to change(GameSession, :count).by(1)
      end

      it "renders a JSON response with the new game_session" do
        post game_sessions_url,
             params: { game_session: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      ...
      it "renders a JSON response with errors for the new game_session" do
        post game_sessions_url,
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested game_session" do
        game_session = GameSession.create! valid_attributes
        patch game_session_url(game_session),
              params: { game_session: invalid_attributes }, headers: valid_headers, as: :json
        game_session.reload
        skip("Add assertions for updated state")
      end

      it "renders a JSON response with the game_session" do
        game_session = GameSession.create! valid_attributes
        patch game_session_url(game_session),
              params: { game_session: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the game_session" do
        game_session = GameSession.create! valid_attributes
        patch game_session_url(game_session),
              params: { game_session: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe "DELETE /destroy" do
    it "destroys the requested game_session" do
      game_session = GameSession.create! valid_attributes
      expect {
        delete game_session_url(game_session), headers: valid_headers, as: :json
      }.to change(GameSession, :count).by(-1)
    end
  end
end
